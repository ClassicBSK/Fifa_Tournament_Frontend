    ...
    const event =async(e)=>{
        ...
        if(result.hasErrors){
            ...
            const {response}=await axios({
                method:"POST",
                url:`${process.env.NEXT_PUBLIC_BACKEND_URI}user/register`,
                data:formDetails, 
                headers: {
        ...
        styles={{
            ...
            <motion.div initial={{x:"-100%",opacity:0}} whileInView={{x:"0%",opacity:1}} transition={{duration:0.4,ease:"easeInOut"}} className='flex items-center w-full'>
                    <div className='w-full' >
                        ...
                        <Text tt="capitalize" ta="center" className='text-2xl' fw={500}>Getting started</Text>
                        <Text fs='italic' ta="center" className='text-md' >Seems you are new here let's setup your profile</Text>                           
                        <div className='pt-[10%] sm:pt-[10%] md:pt-[10%] lg:pt-[10%]'>
                        </div>
                        ...
                        <div className='pt-[8%] sm:pt-[8%] md:pt-[8%] lg:pt-[8%] flex justify-center gap-1'>
                         ...
                         <Text onClick={()=>{location.href='/login'}} className='cursor-pointer' size='sm' c='#006992'>Login</Text>
                         </div>
